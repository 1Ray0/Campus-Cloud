    ...
    >
      ...
      <div
        ...
        className={cn(
          ...
          variant === "floating" || variant === "inset"
            ? "pt-7.5 pb-7.5 pl-7.5 pr-2 group-data-[collapsible=icon]:w-[calc(var(--sidebar-width-icon)+40px)]"
